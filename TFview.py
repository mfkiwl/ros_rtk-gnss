...
class TFRecordNode(object):
	...
	def __init__(self):
		...
		if Quaternion == "false":
			self.r.write("time(s), x(m)   , y(m)   , z(m)   , roll(deg), pitch(deg), yaw(deg)")
			self.r.write("\n")
			print("time(s), x(m)   , y(m)   , z(m)   , roll(deg), pitch(de), yaw(deg)")
			print("000.000, -00.000, -00.000, -00.000, -000.0000, -000.0000, -000.0000")			
	...
	def callback(self, tf_trans, tf_rot):
		...
		if Quaternion == "false":
			...
			self.r.write("{0:07.3f}, {1[0]: 07.3f}, {1[1]: 07.3f}, {1[2]: 07.3f}, {2[0]: 09.4f}, {2[1]: 09.4f}, {2[2]: 09.4f}".format(self.time, tf_trans, euler))
			self.r.write("\n")
			print("{0:07.3f}, {1[0]: 07.3f}, {1[1]: 07.3f}, {1[2]: 07.3f}, {2[0]: 09.4f}, {2[1]: 09.4f}, {2[2]: 09.4f}".format(self.time, tf_trans, euler))	
